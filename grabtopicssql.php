<?php
                    ...
                    $username = $usernames[0];
                     ...
                     <li class="   p-0 m-0 text-dark mb-3 row">
                      <div class="row col-sm-12 bg-light m-0 p-0 text-12 align-content-center" style="height: 40px;"> 
                    <p class="nav-link text-center  title link col-sm-3 center w-100 rounded text-dark">
                    ...
                    <p class="col-sm-3 center rounded text-center bg-light">
                        Posted by:
                    ...
                    <button onclick="location.href='deletetopic.php?topicid=<?php print_r($IDD[$indexpage-1][0]) ?>&origin=<?= $_SERVER['PHP_SELF'] ?>'" class="col-sm-2 text-danger btn h-20p center rounded text-20 text-center">
                    ...
                    <br>
                            ...
                            <div style="background-color: lightgrey;" class="col-sm-12 m-0 p-2">
                    <p class="col-sm-12   rounded  p-3 mb-3  text-light">
                        <span class="text-light text-20">Description:</span><br><br>
